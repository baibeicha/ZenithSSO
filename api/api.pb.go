...
var file_api_proto_api_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_api_proto_api_proto_init() {
	...
	file_api_proto_api_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
